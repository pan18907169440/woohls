...
class Common_util_pub
{
	...
	public $JS_API_CALL_URL = 'http://www.qhbill.com/adwords/pay/weixinNotify';
	
	//=======【异步通知url设置】===================================
	//异步通知url，商户根据实际开发过程设定
	public $NOTIFY_URL = 'http://www.qhbill.com/adwords/pay/weixinNotify';
	...
	function __construct($config='') {
		...
		if(isset($config['appid'])){
			...
			//=======【基本信息设置】=====================================
			//微信公众号身份的唯一标识。审核通过后，在微信发送的邮件中查看
			$this->APPID = 'wx4c094e0da605ebb8';
			//受理商ID，身份标识
			$this->MCHID = '1232257102';
			//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
			$this->KEY = 'F829F3C32EEB5C9EA1E5FB1FD3476A18';
			//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
			$this->APPSECRET = '56fab15bb00723c7829964e2852686c4';		
			//=======【证书路径设置】=====================================
			//证书路径,注意应该填写绝对路径
