...
class Swift_Mime_Headers_MailboxHeader extends Swift_Mime_Headers_AbstractHeader
{
     ...
     * key=>value pairs where (messageEmail => personalName).
     * Example:
     * <code>
     * <?php
    ...
    /**
     * Makes this Header represent a list of plain messageEmail addresses with no names.
     *
     * Example:
     * <code>
     * <?php
     * //Sets three messageEmail addresses as the Header data
     * $header->setAddresses(
    ...
    /**
     * Get all messageEmail addresses in this Header.
     *
     * @see getNameAddresses()
     *
     * @return string[]
