...
class ParameterBagTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFilter()
    {
        $bag = new ParameterBag(array(
            'digits' => '0123ab',
            'messageEmail' => 'example@example.com',
        ...
        $this->assertEquals('example@example.com', $bag->filter('messageEmail', '', FILTER_VALIDATE_EMAIL), '->filter() gets a value of parameter as messageEmail');
